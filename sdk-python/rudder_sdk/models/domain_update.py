...
class DomainUpdate:
    ...
    it needs so the pair stays consistent.
        ...
        Attributes:
            ...
            target_type (DomainTargetType | None | Unset):
    ...
    target_type: DomainTargetType | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.target_type, Unset):
            target_type = UNSET
        elif isinstance(self.target_type, DomainTargetType):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_target_type(data: object) -> DomainTargetType | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, str):
                    raise TypeError()
                target_type_type_0 = DomainTargetType(data)
                ...
                pass
            return cast(DomainTargetType | None | Unset, data)
