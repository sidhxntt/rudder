...
class EnvironmentUpdate:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        is_production: bool | None | Unset
        if isinstance(self.is_production, Unset):
            is_production = UNSET
        else:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_is_production(data: object) -> bool | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        is_production = _parse_is_production(d.pop("is_production", UNSET))
        ...
        environment_update.additional_properties = d
