...
if TYPE_CHECKING:
  from ..models.service_create_build_config import ServiceCreateBuildConfig
...
class ServiceCreate:
    ...
    ``{name}.{environment}.{base_domain}``.
        ...
        Attributes:
            ...
            build_config (ServiceCreateBuildConfig | Unset): Free-form build knobs consumed by the builder.
    ...
    build_config: ServiceCreateBuildConfig | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        build_config: ServiceCreateBuildConfig | Unset
        if isinstance(_build_config,  Unset):
            build_config = UNSET
        else:
            build_config = ServiceCreateBuildConfig.from_dict(_build_config)
