...
def sync_detailed(
    ...
    *,
    ...
    """ Partially update an environment
     ...
     Renaming rewrites the system hostname of every service in this environment, since the environment
    name is a label in `{service}.{environment}.{base_domain}`.

    Args:
        environment_id (UUID):
        body (EnvironmentUpdate): Body of ``PATCH /environments/{id}``. Absent fields are left
            alone.
