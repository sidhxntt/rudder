...
def sync_detailed(
    ...
    *,
    ...
    """ Partially update a domain
     ...
     Retargeting a domain is the rollback primitive: an UPDATE, not a rebuild. Send `target_type`
    together with the id it requires. Refused with 403 on a system domain.

    Args:
        domain_id (UUID):
        body (DomainUpdate): Body of ``PATCH /domains/{id}``. Absent fields are left alone.
